...
function ResetInner() {
  ...
  return (
    <div className="min-h-screen grid place-items-center px-4 py-10 sm:py-14" style={{ background: "linear-gradient(160deg, #FFFFFF 0%, #FDF3EC 100%)" }}>
      <div className="relative w-full max-w-[440px] overflow-hidden rounded-[1.75rem] sm:rounded-[2.25rem] bg-white shadow-[0_40px_90px_-30px_rgba(174, 34, 87,.30)] ring-1 ring-black/5 px-7 sm:px-10 py-10 sm:py-12">
        <div className="flex items-center justify-center">
          <span className="grid h-11 w-11 place-items-center rounded-full text-white shadow-[0_10px_24px_-8px_rgba(209, 53, 111,.6)]"
            style={{ background: "linear-gradient(135deg, #EE6A9A, #AE2257)" }}>
