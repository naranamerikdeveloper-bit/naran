...
// Main line (same as the site footer) plus the office line.
const PHONE = "9882-4848";
const PHONE_HREF = "tel:+97698824848";
const PHONE2 = "7212-3060";
const PHONE2_HREF = "tel:+97672123060";
...
const ADDRESS2 = "Улаанбаатар хот, Сүхбаатар дүүрэг, 100 айл, Монгол 3-р сургуулийн хойно 42в байр";
...
export function PolicyHighlights() {
  const items: [string, string][] = [
    ["100% Оригинал", "АНУ, Канадаас албан ёсны эх хувь"],
    ["24–48 цагийн хүргэлт", "Улаанбаатар & Орон нутаг"],
    ["Найдвартай төлбөр", "QPay ба бүх банкны апп"],
...
export function TermsPart() {
  return (
    <Part id="sec-terms" n="I" title="ҮЙЛЧИЛГЭЭНИЙ НӨХЦӨЛ">
      ...
      <p>{b("2.1.")} Манай дэлгүүрт худалдаалагдаж буй үнэртэй ус, гоо сайхны бүх бүтээгдэхүүн нь АНУ, Канадын албан ёсны дистрибьютерүүдээс нийлүүлэгддэг {b("100% оригинал")}, чанарын баталгаатай эх хувь байна.</p>
      ...
      <div className="flex flex-wrap gap-2 my-1">
        {["QPay", "Бүх банкны апп (QPay QR / банкны апп руу шилжих холбоос)"].map(t => (
          <span key={t} className="rounded-lg border border-line bg-mist px-3 py-2 text-[13px] font-semibold text-ink">{t}</span>
        ))}
      </div>
      <p>{b("3.3.")} Захиалга хийх үед гарч ирэх QPay QR кодыг уншуулах эсвэл банкны апп руу шилжих холбоосоор төлнө. Төлбөр орсон даруйд захиалга автоматаар баталгаажна. Төлбөртэй холбоотой асуудал гарвал Хэрэглэгчтэй харилцах төв (<a href={PHONE_HREF} className="text-accent font-semibold">{PHONE}</a>)-д хандана уу.</p>
      <Notice tone="warn">
        <strong>Анхааруулга:</strong> <strong>3.4.</strong> QR код гарснаас хойш <strong>30 минутын дотор</strong> төлөгдөөгүй захиалга хүчингүй болж, захиалсан бараа үндсэн үлдэгдэл рүү шилжинэ.
      </Notice>

      <Sub>4. Хүргэлтийн нөхцөл</Sub>
      <p>{b("4.1. Улаанбаатар хот доторх энгийн хүргэлт:")} Захиалга баталгаажсанаас хойш {b("24–48 цагийн дотор")} хүргэгдэнэ. Одоогоор хүргэлт {b("үнэгүй")}. Хүргэлтийн хураамж тогтоогдсон тохиолдолд захиалга хийх үед төлбөрийн дүнд урьдчилан харуулна.</p>
...
export function PrivacyPart() {
  return (
    <Part id="sec-privacy" n="II" title="НУУЦЛАЛЫН БОДЛОГО">
      ...
      <Sub>4. Cookie болон аналитик</Sub>
      <p>{b("4.1.")} Вэб сайт нь сагс, нэвтрэлт, хэлний сонголт зэрэг ажиллагаанд зайлшгүй шаардлагатай cookie болон хөтчийн санах ойг ашиглана.</p>
      <p>{b("4.2.")} Хэрэглэгч cookie мэдэгдэл дээр “Зөвшөөрөх” дарсан тохиолдолд л сайтын хэрэглээг сайжруулах зорилгоор Google Analytics болон Meta (Facebook)-ийн аналитик хэрэгслийг ачаална. “Зөвхөн чухал” сонгосон бол эдгээрийг ачаалахгүй.</p>
      <p>{b("4.3.")} Сонголтоо өөрчлөх бол хөтчийнхөө энэ сайтад хадгалсан мэдээллийг устгахад cookie мэдэгдэл дахин гарна.</p>
    </Part>
  );
}
...
export function ContactPart({ n = "IV" }: { n?: string }) {
  const cards: [string, React.ReactNode, boolean?][] = [
    ...
    ["Холбогдох утас", <span key="p"><a href={PHONE_HREF} className="text-accent">{PHONE}</a>, <a href={PHONE2_HREF} className="text-accent">{PHONE2}</a></span>],
